...
class BillSuccessScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      showSuccess: true,
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flex: 0.8, marginHorizontal: 30, alignItems: 'center', justifyContent: 'center'}}>
          ...
          <Text style={{fontSize: 35, fontWeight: 'bold', color: 'black'}}>CFA {this.props.MoneyState.billAmount}</Text>
          <Text style={{fontSize: 18, color: 'grey', textAlign: 'center', fontFamily: ThemeStyle.Poppin, marginTop: 20, }}>Your bill payment is successfull for 
          </Text>
          <Text style={{fontSize: 18, color: 'grey', textAlign: 'center', fontFamily: ThemeStyle.Poppin, marginTop: 5, }}>CFA {this.props.MoneyState.billAmount} from KalPay</Text>
        </View>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          ...
          <Text style={{fontSize: 25, color: 'black', marginTop: 20}}>CFA {this.props.MoneyState.billAmount}</Text>
        </View> }
...
export default connect(mapStateToProps, mapDispatchToProps)(BillSuccessScreen);
