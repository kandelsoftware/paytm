...
class MobilePayAmountScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number  : '',
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.navigation.navigate('MobilePayPinScreen', {mobileNumber : this.state.mobileNumber, companyId: this.state.companyId, amount: this.state.number});
    }
  }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
          ...
          <View style={{backgroundColor: 'white', borderWidth:1, borderColor: 'white', elevation: 5, marginHorizontal: 40, borderBottomRightRadius: 10, borderBottomLeftRadius: 10, paddingVertical: 0}}>
            ...
            <Text style={styles.phoneText}>Enter amount</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(MobilePayAmountScreen);
