...
class RequestCancelScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.MoneyState.cancelSuccess == true){
      const resetAction = StackActions.reset({
        index: 0,
        actions: [NavigationActions.navigate({ routeName: 'RequestMoneyScreen'})],
      });
            ...
            <View style={{paddingBottom: 15, marginHorizontal: 50,}}>
              ...
              <View>
                ...
                <TouchableOpacity 
                  ...
                  // onPress={()=>this.props.navigation.navigate('RequestSuccessScreen')}
                  style={styles.box1}>
...
export default connect(mapStateToProps, mapDispatchToProps)(RequestCancelScreen);
