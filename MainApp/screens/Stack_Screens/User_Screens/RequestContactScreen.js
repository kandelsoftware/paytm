...
class RequestContactScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      numberList   : true,
  ...
  numberSuccess = () => {
    ...
    if(phoneNoValid) {
      ...
      // this.props.navigation.navigate('RequestAmountScreen', {mobileNumber: mobileNumber});
  ...
  componentWillReceiveProps(nextProps){
    if(this.props.MoneyState.numberValid == false && nextProps.MoneyState.numberValid == true){
      ...
      this.props.ResetNumber();
       this.props.navigation.navigate('RequestAmountScreen');
    }
  }
      ...
      <View style={styles.container}>
         <LinearGradient colors={['#7A00D2', '#5217ee']} style={{flexDirection: 'row', height: 80, alignItems: 'flex-end', paddingBottom: 10}}>
          ...
          <View 
            ...
            <Text style={{fontSize: 20, fontFamily: ThemeStyle.PoppinsMedium, color: 'white'}}>Requesting Number</Text>
          </View>
        </LinearGradient>
...
export default connect(mapStateToProps, mapDispatchToProps)(RequestContactScreen);
