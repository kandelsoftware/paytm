...
class RequestPinScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.MoneyState.requestAccepted == true){
      const resetAction = StackActions.reset({
        index: 0,
        actions: [NavigationActions.navigate({ routeName: 'RequestSuccessScreen'})],
      });
...
export default connect(mapStateToProps, mapDispatchToProps)(RequestPinScreen);
