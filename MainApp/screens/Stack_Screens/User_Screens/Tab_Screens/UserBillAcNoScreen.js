...
class UserBillAcNoScreen extends Component {
  render() {
    return (
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{marginHorizontal: 20, marginTop:20, }}>
            ...
            <View style={{alignItems: 'flex-end', marginTop: 15,}}>
              <TouchableOpacity onPress={() => this.props.screenProps.parentNavigation.navigate('UserBillAmountScreen')}
...
export default UserBillAcNoScreen;
