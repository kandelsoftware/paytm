...
class UserBuyForSomeoneScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      phoneNumber        : true,
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.screenProps.parentNavigation.navigate('UserBuySuccessScreen')
    }
  }
...
export default UserBuyForSomeoneScreen;
