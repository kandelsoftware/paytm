...
class TopupAmountScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number  : '',
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.navigation.navigate('TopupPinScreen', {mobileNo : this.state.mobileNumber, companyId: this.state.companyId, amount: this.state.number});
    }
  }
