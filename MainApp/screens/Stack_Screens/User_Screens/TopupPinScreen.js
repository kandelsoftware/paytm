...
import {AC_TopupProcess} from '../../../reducers/Money_Reducer/actions';

class TopupPinScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  componentDidMount(){
    ...
    this.setState({
      mobileNumber : state.params.mobileNo,
  ...
  nextScreen = () => {
    ...
    this.props.TopupProcess(formData);
    
  }

  componentWillReceiveProps(nextProps){
    if(nextProps.MoneyState.topupSuccess == true){
...
function mapDispatchToProps(dispatch){
  return bindActionCreators({
    TopupProcess : AC_TopupProcess,
  }, dispatch)
}
 
export default connect(mapStateToProps,mapDispatchToProps)(TopupPinScreen);
