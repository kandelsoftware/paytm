...
import UserBuyForMeScreen from './Tab_Screens/UserBuyForMeScreen';
import UserBuyForSomeoneScreen from './Tab_Screens/UserBuyForSomeoneScreen';

class UserBuyScreen extends Component {
  render() {
    return (
...
const AppTab = createMaterialTopTabNavigator({ 
  UserBuyForMeScreen: {
    screen: UserBuyForMeScreen,
    navigationOptions: {
      tabBarLabel: 'For Me',
    }
  }, 
  UserBuyForSomeoneScreen: {
    screen: UserBuyForSomeoneScreen,
    navigationOptions: {
