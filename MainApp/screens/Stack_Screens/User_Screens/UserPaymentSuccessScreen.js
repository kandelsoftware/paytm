...
class UserPaymentSuccessScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flex: 0.8, marginHorizontal: 30, alignItems: 'center', justifyContent: 'center'}}>
          ...
          <Text style={{fontSize: 35, fontWeight: 'bold', color: 'black'}}>CFA {this.props.MoneyState.payingAmount}</Text>
          <Text style={{fontSize: 18, color: 'grey', textAlign: 'center', fontFamily: ThemeStyle.Poppin, marginTop: 20, }}>You Paid CFA {this.props.MoneyState.payingAmount} to</Text>
          <Text style={{fontSize: 18, color: 'grey', textAlign: 'center', fontFamily: ThemeStyle.Poppin}}>{this.props.MoneyState.payeeDetails.fullName}</Text>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(UserPaymentSuccessScreen);
