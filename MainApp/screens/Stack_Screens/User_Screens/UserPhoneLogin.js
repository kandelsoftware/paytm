...
class UserRegisterScreen extends Component {
  ...
  onSubmit = () => {
    ...
    if(phoneNoValid) {
      ...
      this.props.navigation.navigate('UserLoginScreen', {mobileNumber: mobileNumber});
      ...
      <View style={styles.container}>
        ...
        <LinearGradient colors={['#7A00D2', '#5217ee']} style={styles.linearGradient}>
          ...
          <View style={styles.section12}>
            ...
            <Text style={styles.confirmText}>Confirm your country code and enter your phone number to login</Text>
          </View>
