...
class UserReceiveAmountScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number  : '',
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.navigation.navigate('UserAmountReceivedScreen')
    }
  }
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.phoneText}>Enter amount to receive</Text>
...
export default UserReceiveAmountScreen;
