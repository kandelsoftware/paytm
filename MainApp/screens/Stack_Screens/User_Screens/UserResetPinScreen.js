...
import { AC_PinReset } from '../../../reducers/Account_Reducer/actions';

class UserResetPinScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  componentWillReceiveProps(nextProps){
    if(this.props.AccountState.pinReset == false && nextProps.AccountState.pinReset == true){
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.phoneText}>Reset Pin</Text>
...
function mapDispatchToProps(dispatch){
	return bindActionCreators({PinReset:AC_PinReset}, dispatch)
}

export default connect(mapStateToProps, mapDispatchToProps)(UserResetPinScreen);
