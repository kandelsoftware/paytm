...
class UserResignupScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  nextScreen = () => {
    ...
    if((number1 && number2 && number3 && number4) != ''){
      ...
      if(this.state.pin1 === pin){
        this.props.navigation.navigate('UserQuestionScreen', {Pin : pin});
      }else {
        alert('Pin dosent match');
      }
    } else {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.confirmText}>Confirm your 4 digit PIN</Text>
...
export default UserResignupScreen;
