...
import { View, Text, StyleSheet,Image, TouchableOpacity, TextInput, KeyboardAvoidingView,PanResponder } from "react-native";
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {    
        ...
        if(this.state.ballTop < 30) {
          this.props.navigation.navigate('UserRetrieveQrScreen');
          this.setState({ballTop: 120});
        } else if(this.state.ballTop > 210) {
          this.props.navigation.navigate('UserRouterNumberScreen');
          this.setState({ballTop: 120});
        }
