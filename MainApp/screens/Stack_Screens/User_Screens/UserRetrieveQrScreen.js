...
class UserRetrieveQrScreen extends Component {
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          ...
          <TouchableOpacity onPress={()=>this.props.navigation.navigate('UserAmountRetrieveScreen')}>
...
export default UserRetrieveQrScreen;
