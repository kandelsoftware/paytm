...
class UserRouterNumberScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.confirmText}>ENTER ROUTER NUMBER</Text>
            ...
            <View style={{paddingBottom: 30, marginHorizontal: 50,}}>
              ...
              <TouchableOpacity onPress={()=>this.props.navigation.navigate('UserRetrieveBankScreen')}
                style={styles.box1}>
...
export default UserRouterNumberScreen;
