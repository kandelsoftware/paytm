...
class UserSendAmountScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number  : '',
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.navigation.navigate('UserSendPinScreen', {amount: this.state.number});
    }
  }
  render() {
...
export default connect(mapStateToProps, mapDispatchToProps)(UserSendAmountScreen);
