...
import { AC_UserScanToPay, AC_UserPaying, AC_UserSendMoney } from '../../../reducers/Money_Reducer/actions';

class UserSendPinScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  nextScreen = () => {
    ...
    this.props.UserSendMoney(formData);
  }

  componentWillReceiveProps(nextProps){
    if(nextProps.MoneyState.sendSuccess == true){
      const resetAction = StackActions.reset({
          index: 0,
          actions: [NavigationActions.navigate({ routeName: 'UserSendSuccessScreen'})],
        });
...
export default connect(mapStateToProps, mapDispatchToProps)(UserSendPinScreen);
