...
class ViewBillPaymentsScreen extends Component {
  ...
  renderItems(rowData) {
      ...
      <View style={{width: width/3-14, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'lightgrey', marginRight: 10, marginBottom: 10, paddingVertical: 15}}>
				<TouchableOpacity 
        onPress={()=>this.props.navigation.navigate('BillProcessScreen', {billId : rowData.item.id, billName : rowData.item.name})} style={{alignItems: 'center', justifyContent: 'center'}}
        >
      ...
      <View style={styles.container}>
        ...
        <View style={{flex: 1}}>
          <View style={{marginHorizontal: 20, marginTop: 15}}>
            <Text style={{color: ThemeStyle.ThemeColor, fontSize: 18}}>Bill companies</Text>
          </View>
...
export default connect(mapStateToProps)(ViewBillPaymentsScreen);
