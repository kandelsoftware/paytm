...
class UserSendMoneyQrScreen extends Component {
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          ...
          <TouchableOpacity onPress={() => this.props.screenProps.parentNavigation.navigate('VendorSendAmountScreen')}>
...
export default UserSendMoneyQrScreen;
