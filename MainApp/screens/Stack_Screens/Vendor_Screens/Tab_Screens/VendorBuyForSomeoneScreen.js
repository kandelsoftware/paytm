...
class VendorBuyForSomeoneScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      phoneNumber        : true,
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.screenProps.parentNavigation.navigate('VendorBuySuccessScreen')
    }
  }
      ...
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            {this.state.number.length > 0 ?
              <View style={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'row', }}>
                ...
                <Text style={{fontSize: 30, color: 'black'}}>{this.state.number}</Text>
              </View> : 
              
              <View style={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'row', }}>
                <Text style={{fontSize: 30, color: 'black'}}>$ </Text>
                <Text style={{fontSize: 30, color: 'black'}}>0</Text>
              </View>
            ...
            <View style={{paddingBottom: 15, marginHorizontal: 50,}}>
              ...
              <TouchableOpacity onPress={()=>this.showConfirmPhoneScreen()}
                style={styles.box1}>
        ...
        {this.state.confirmPhoneNumber == true ?
          ...
          <View style={styles.section12}>
              ...
              <Text style={styles.phoneText}>Confirm Phone Number</Text>
              ...
              <View style={{paddingBottom: 15, marginHorizontal: 50,}}>
                ...
                <TouchableOpacity onPress={()=>this.showAmountScreen()}
                  style={styles.box1}>
                  <Text style={styles.box1Font}>Ok</Text>
                </TouchableOpacity>
...
export default VendorBuyForSomeoneScreen;
