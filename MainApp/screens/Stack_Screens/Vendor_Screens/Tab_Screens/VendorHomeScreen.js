...
class UserHomeScreen extends Component {
  ...
  renderItems(rowData) {
      ...
      <View style={{flexDirection: 'row', width: width/3-13, alignItems: 'center', 
        justifyContent: 'center', borderRightWidth: 1, marginTop: 15, borderRightColor: 'lightgrey'}}>
				<TouchableOpacity onPress={()=>this.props.screenProps.parentNavigation.navigate('VendorBillPaymentsScreen')}>
  ...
  renderairItems(rowData) {
      ...
      <View style={{flexDirection: 'row', width: width/3-13, alignItems: 'center', 
        justifyContent: 'center', borderRightWidth: 1, marginTop: 15, borderRightColor: 'lightgrey'}}>
				<TouchableOpacity onPress={()=>this.props.screenProps.parentNavigation.navigate('VendorBuyScreen')}>
          <Image source={rowData.item.image} style={{height: 60, width: 60, resizeMode: 'contain'}}/>
        </TouchableOpacity>
      </View>
		)
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <LinearGradient colors={['#7A00D2', '#5217ee']} style={{paddingVertical: 15,}}>
            ...
            <View style={{flexDirection: 'row', paddingHorizontal: 12, justifyContent: 'space-between'}}>
              ...
              <TouchableOpacity onPress={() => this.props.screenProps.parentNavigation.navigate('VendorPayScreen')}
              ...
              <View style={{alignItems: 'flex-end'}}>
                ...
                <TouchableOpacity onPress={() => this.props.screenProps.parentNavigation.navigate('VendorAddMoneyScreen')}
            ...
            <View style={styles.mainTab}>
              ...
              <View style={styles.tabCircle}>
                <TouchableOpacity onPress={()=>this.props.screenProps.parentNavigation.navigate('VendorSendMoneyScreen')} 
                  style={styles.tabCircle0}>  
                  <View style={styles.tabCircle1}>
                    <Image source={require('../../../../src/mobPay.png')} style={{height: 25, width: 25}}/>
                  </View>
              ...
              <View style={styles.tabCircle}>
               <TouchableOpacity onPress={()=>this.props.screenProps.parentNavigation.navigate('VendorReceiveMoneyScreen')} 
                  style={styles.tabCircle0}>  
                  <View style={styles.tabCircle1}>
              ...
              <View style={[styles.tabCircle, {borderRightWidth: 0}]}>
                <TouchableOpacity onPress={()=>this.props.screenProps.parentNavigation.navigate('VendorRetrieveMoneyScreen')}
                  style={styles.tabCircle0}>    
                  <View style={styles.tabCircle1}>
