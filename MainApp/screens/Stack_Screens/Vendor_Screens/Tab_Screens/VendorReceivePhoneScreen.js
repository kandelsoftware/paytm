...
class VendorReceivePhoneScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      numberList   : true,
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.screenProps.parentNavigation.navigate('VendorReceiveSuccessScreen')
    }
  }
...
export default VendorReceivePhoneScreen;
