...
class VendorRetrieveScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      phoneNumber        : true,
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.navigation.navigate('VendorRetrieveStartScreen')
    }
  }
        ...
        {this.state.uniqueScreen == true ?
          ...
          <View style={styles.section12}>
              ...
              <View style={{paddingBottom: 15, marginHorizontal: 50,}}>
                ...
                <TouchableOpacity onPress={()=>this.props.screenProps.parentNavigation.navigate('VendorRetrieveStartScreen')}
                  style={styles.box1}>
...
export default VendorRetrieveScreen;
