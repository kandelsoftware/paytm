...
class VendorBillAmountScreen extends Component {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{marginHorizontal: 30, }}>
          <TouchableOpacity onPress={()=>this.props.navigation.navigate('VendorBillAmountPayScreen')}
            style={styles.box1}>
...
export default VendorBillAmountScreen;
