...
class VendorBuySuccessScreen extends Component {
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={{flex: 0.8, marginHorizontal: 30, alignItems: 'center', justifyContent: 'center'}}>
          ...
          <Text style={{fontSize: 18, color: 'grey', textAlign: 'center', fontFamily: ThemeStyle.Poppin, marginTop: 20,}}>You have bought $ 300 from orange</Text>
        </View>
...
export default VendorBuySuccessScreen;
