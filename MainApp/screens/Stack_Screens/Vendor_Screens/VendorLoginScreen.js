...
class VendorLoginScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  nextScreen = () => {
    ...
    if((number1 && number2 && number3 && number4) != ''){
      this.props.navigation.navigate('VendorMainScreen');
    } else {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.phoneText}>Returning Vendor</Text>
            ...
            <View style={styles.forgotStyle}>
              <TouchableOpacity onPress={()=>this.props.navigation.navigate('VendorForgotPasswordScreen')}>
