...
class VendorPasswordVerificationScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.phoneText}>Verification Pin</Text>
...
export default VendorPasswordVerificationScreen;
