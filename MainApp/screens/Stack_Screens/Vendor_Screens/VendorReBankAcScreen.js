...
class VendorReBankAcScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number1 : '',
  ...
  getNumber = (num) => {
   ...
   nextScreen = () => {
     ...
     if((number1 && number2 && number3 && number4) != ''){
       this.props.navigation.navigate('VendorRetrieveSuccessScreen');
     } else {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.confirmText}>ENTER Ac NUMBER</Text>
...
export default VendorReBankAcScreen;
