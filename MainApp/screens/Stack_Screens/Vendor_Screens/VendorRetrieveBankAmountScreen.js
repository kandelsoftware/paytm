...
class VendorRetrieveBankAmountScreen extends Component {
  constructor(props){
    super(props);
    this.state = {
      number  : '',
  ...
  nextScreen = () => {
    if(this.state.number.length > 0){
      this.props.navigation.navigate('VendorBankAcScreen')
    }
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.section12}>
            ...
            <Text style={styles.confirmText}>Enter Amount</Text>
            ...
            <View style={{paddingBottom: 15, marginHorizontal: 50,}}>
              ...
              <View>
                ...
                <TouchableOpacity onPress={()=>this.nextScreen()}
                  style={styles.box1}>
                  <Text style={styles.box1Font}>Confirm</Text>
                </TouchableOpacity>
...
export default VendorRetrieveBankAmountScreen;
